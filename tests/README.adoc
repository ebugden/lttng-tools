...
Legacy tests are principally written in bash, and some are in C/{cpp}. C/{cpp} tests
must be limited to those that actually require interacting with loaded libraries or
internal testpoints.
