 ...
 *
 * trace_archive_location The location of the trace archive generated by
 *         the last session rotation. Null if not applicable to this
 *         session or if an error occured.
 */
